...
/**
 * Copied from https://github.com/drizzle-team/drizzle-orm/pull/2860
 * Can be removed once the above is merged and released
 */
...
> = TColumn['_']['notNull'] extends false
  ? OptionalSchema<NullableSchema<TType, never>, never>
  : TColumn['_']['hasDefault'] extends true
  ? OptionalSchema<TType, never>
  : TType;
...
> = TMode extends 'insert' ? MapInsertColumnToValibot<TColumn, TType> : MapSelectColumnToValibot<TColumn, TType>;
...
> = TNoOptional extends true ? TType : MapColumnToValibot<TColumn, TType, TMode>;
...
type GetValibotType<TColumn extends Column> = TColumn['_']['dataType'] extends infer TDataType
  ? TDataType extends 'custom'
    ...
    ? Equal<TColumn['enumValues'], [string, ...string[]]> extends true
      ? StringSchema<undefined> | SchemaWithPipe<[StringSchema<undefined>, MaxLengthAction<string, number, undefined>]>
      : PicklistSchema<TColumn['enumValues'], undefined>
    : TDataType extends 'array'
    ? TColumn['_']['baseColumn'] extends Column
      ? ArraySchema<GetValibotType<TColumn['_']['baseColumn']>, undefined>
      : never
  ...
  ? {
      [K in keyof TColumns & string]: MaybeOptional<
        ...
        K extends keyof TRefine
          ? Assume<UnwrapValueOrUpdater<TRefine[K]>, BaseSchema<unknown, unknown, BaseIssue<unknown>>>
...
function isWithEnum(column: AnyColumn): column is typeof column & { enumValues: [string, ...string[]] } {
