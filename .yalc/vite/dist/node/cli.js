...
import { C as colors, x as createLogger, h as resolveConfig } from './chunks/dep-ff5331fa.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./chunks/dep-ff5331fa.js').then(function (n) { return n.H; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('./chunks/dep-ff5331fa.js').then(function (n) { return n.G; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('./chunks/dep-ff5331fa.js').then(function (n) { return n.F; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('./chunks/dep-ff5331fa.js').then(function (n) { return n.I; });
    try {
